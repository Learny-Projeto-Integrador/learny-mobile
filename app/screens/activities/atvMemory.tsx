  ...
  export default function AtvMemoryScreen() {
    ...
    return (
      <ScrollView style={styles.container}>
        <View style={styles.containerDados}>
          ...
          <View style={{ justifyContent: "center", gap: 10 }}>
            <View style={styles.containerNamePhase}>
              <Text style={styles.txt}>Memory</Text>
              <Text style={[styles.txt, {marginTop: -height * 0.01}]}>Game</Text>
            </View>
          </View>
        ...
        <View style={{flexDirection: "row", flexWrap: "wrap", gap: width * 0.03, justifyContent: "center" }}>
              <Image
                source={require("../../../assets/images/cards/card-amarelo.png")}
                style={styles.card}
              />
              <Image
                source={require("../../../assets/images/cards/card-vermelho.png")}
                style={styles.card}
              />
              <Image
                source={require("../../../assets/images/cards/card-verde.png")}
                style={styles.card}
              />
              <Image
                source={require("../../../assets/images/cards/card-amarelo.png")}
